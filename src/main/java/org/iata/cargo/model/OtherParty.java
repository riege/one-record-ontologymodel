 ...
 * 
 */
@OWLClass(iri = OtherParty.s_c_OtherParty)
@Deprecated
    ...
    implements Serializable
{
     ...
     * 
     */
    @OWLObjectProperty(iri = OtherParty.s_p_companyDetails)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Thing, max = 1)
    })
    @JsonProperty(OtherParty.s_p_companyDetails)
     ...
     * 
     */
    @OWLDataProperty(iri = OtherParty.s_p_partyTypeCode)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = "http://www.w3.org/2001/XMLSchema#string", min = 1, max = -1),
        @ParticipationConstraint(owlObjectIRI = "http://www.w3.org/2001/XMLSchema#string", max = 1)
    })
    @JsonProperty(OtherParty.s_p_partyTypeCode)
     ...
     * 
     */
    @OWLDataProperty(iri = OtherParty.s_p_roleName)
    @ParticipationConstraints({
        @ParticipationConstraint(owlObjectIRI = "http://www.w3.org/2001/XMLSchema#string", max = 1)
    })
    @JsonProperty(OtherParty.s_p_roleName)
