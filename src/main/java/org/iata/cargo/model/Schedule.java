    ...
    implements Serializable
{
    ...
    @JsonProperty(Vocabulary.s_p_latestAcceptanceTime_A_A)
    ...
    @JsonProperty(Vocabulary.s_p_timeOfAvailability_A_A)
    ...
    @JsonProperty(Vocabulary.s_p_totalTransitTime_A_A)
